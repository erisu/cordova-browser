...
/**
 * @typedef CordovaDevServeOptions
 * @type {object}
...
class CordovaDevServe {
    ...
    /**
     *
     * @param {CordovaDevServeOptions} serverOpts
     */
    ...
    #serverOnListening (resolve, reject) {
        ...
        this.appUrl = new URL(`${scheme}://localhost:${port}/${this.#serverOpts.startUrl}`);
        ...
        const message = dedent`
            ...
            (${CordovaDevServe.#isDarwin ? 'Control' : 'CTRL'} + C to shut down)\n
        `;
        console.log(message);
...
module.exports = CordovaDevServe;
